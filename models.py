...
def PSSD(**kwargs):
    return PSSDModel(**kwargs)

PSSD_models = {"PSSD": PSSD}
# could set models with different sizes as default options in dictionary "PSSD_models". 
